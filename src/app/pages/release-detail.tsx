  ...
  return (
    <div className="min-h-screen pt-32 pb-20 px-4 sm:px-6 lg:px-8">
      <div className="max-w-5xl mx-auto">
        <Link to="/music" className="inline-flex items-center text-accent hover:text-accent-hover mb-8 transition-colors">
        ...
        <div className="grid md:grid-cols-2 gap-12">
          ...
          <div>
            ...
            <h1 className="font-heading text-5xl mb-4">{release.title}</h1>
            ...
            <div className="bg-surface border border-border rounded-lg p-8 mb-8">
              <div className="flex flex-col items-center justify-center text-center">
                <Music size={64} className="mb-4 text-accent opacity-50" />
            ...
            {release.tracks && release.tracks.length > 0 && (
              <div className="mb-8">
                <h3 className="font-heading text-2xl mb-4">TRACKLIST</h3>
